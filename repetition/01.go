...
// 3. Implement a main function to print a message to the console. A main function executes by default when you run the main package. The Go compiler need to know where to start.
func main() {
	fmt.Println("Hello world! Repetition 1")
}